...
import { ShieldCheck, Upload, PenTool, Key, CheckCircle, X } from 'lucide-react';
...
export default function GorevTanimiOnay({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('GorevTanimiOnay - employeeId:', employeeId);
      console.log('GorevTanimiOnay - passcodeData:', passcodeData);
      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold">Görev Tanımı Onayı</h2>
          </div>
          <button
            onClick={onClose}
