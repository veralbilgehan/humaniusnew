  ...
  public: {
    Tables: {
      ...
      izin_talepleri: {
        ...
        Relationships: [
          {
            foreignKeyName: "izin_talepleri_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "izin_talepleri_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
      ...
      izin_haklari: {
        ...
        Relationships: [
          {
            foreignKeyName: "izin_haklari_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "izin_haklari_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
      ...
      bordro_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "bordro_items_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "bordro_items_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
      ...
      ozluk_dosyalari: {
        ...
        Relationships: [
          {
            foreignKeyName: "ozluk_dosyalari_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ozluk_dosyalari_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
