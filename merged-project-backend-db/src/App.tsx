...
const AppInner: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const demoEmployees: Employee[] = [
      {
        ...
        tc_no: '12345678901',
        sicil_no: 'EMP001',
        company: 'Humanius Demo Sirketi',
        department: 'Yazilim',
        position: 'Kidemli Gelistirici',
        level: 'Senior',
        salary: 75000,
        status: 'active',
        phone: '05320000001',
        email: 'ahmet@demo.local',
        joinDate: '2022-01-15',
    ...
    const demoIzinTalepleri: IzinTalebi[] = [
      {
        id: '00000000-0000-0000-0000-000000000201',
        companyId: demoCompanyId,
        employeeId: '00000000-0000-0000-0000-000000000103',
        izinTuru: 'yillik',
        baslangicTarihi: `${currentYear}-04-10`,
        bitisTarihi: `${currentYear}-04-14`,
        gunSayisi: 5,
    ...
    const demoIzinHaklari: IzinHakki[] = [
      {
        ...
        kalanIzin: 12,
        calismaYili: 3,
        iseGirisTarihi: '2022-01-15',
        hesaplamaTarihi: `${currentYear}-01-01`,
        mazeretIzin: 0,
        hastalikIzin: 1,
        mazeret: 0,
        createdAt: now,
    ...
    const demoBordrolar: BordroItem[] = [
      {
        id: '00000000-0000-0000-0000-000000000401',
        company_id: demoCompanyId,
        employee_id: '00000000-0000-0000-0000-000000000101',
        period: `${currentYear}-03`,
        sicil_no: 'EMP001',
        tc_no: '12345678901',
        brut_maas: 75000,
        medeni_durum: 'evli',
        ...
        diger_kazanclar: 0,
        fazla_mesai: 0,
        fazla_mesai_saat_50: 0,
        fazla_mesai_saat_100: 0,
        fazla_mesai_tutar: 0,
        haftalik_tatil: 0,
        genel_tatil: 0,
        yillik_izin_ucreti: 0,
        ikramiye: 0,
        prim: 0,
        servis_ucreti: 0,
        temsil_etiket: 0,
        ...
        toplam_kesinti: 0,
        net_maas: 75000,
        kumulatif_vergi_matrahi: 0,
        asgari_ucret_gelir_vergisi_istisnasi: 0,
        asgari_ucret_damga_vergisi_istisnasi: 0,
        sgk_isveren_payi: 0,
        issizlik_isveren_payi: 0,
        sgk_isveren_indirimi: 0,
        sgk_isveren_indirim_orani: 0,
        yillik_toplam_kazanc: 75000,
        yillik_toplam_kesinti: 0,
        yillik_toplam_net: 75000,
        aciklama: 'Demo bordro kaydi',
        created_at: now,
        updated_at: now,
        employees: {
          name: 'Ahmet Yilmaz',
    ...
    setStats({ active: 2, onLeave: 1, inactive: 0 });
    setDepartments(['Yazilim', 'Insan Kaynaklari', 'Muhasebe']);
    setCompanies(['Humanius Demo Sirketi']);
    setIzinTalepleri(demoIzinTalepleri);
    setIzinHaklari(demoIzinHaklari);
    setBordrolar(demoBordrolar);
